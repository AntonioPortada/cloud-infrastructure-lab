...
- Aprenda la infraestructura en la nube paso a paso
- Documentar experimentos prácticos reales
- Construir una cartera progresiva de DevOps
...
- Configuración inversa del proxy
- Redes Docker
...
### V2 — Redes Docker + Servicios Múltiples

Arquitectura multiservicio conectada a través de la red docker.
